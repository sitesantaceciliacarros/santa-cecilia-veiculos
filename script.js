...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ---- Supabase Config ----
  const SUPABASE_URL = 'https://hmqucnhanrjxfenjzaz.supabase.co';
  ...
  document.querySelectorAll('.pill').forEach(pill => {
    pill.addEventListener('click', () => {
      ...
      else if (text.includes('comercial')) { renderCards(vehicles.filter(v => v.type === 'comercial')); }
