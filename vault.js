/**
 * SANTA CÉCILIA VEÍCULOS — Secure Vault (EMERGENCY TRANSPARENCY)
...
(function() {
    ...
    // SUPABASE CONFIG - TRANSPARENT FOR DEBUGGING
    ...
    if (window.supabase) {
        ...
        console.log("🛡️ Vault: Supabase client initialized (Transparent Mode).");
    } else {
